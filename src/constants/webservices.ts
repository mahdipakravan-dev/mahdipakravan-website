export const BASE_URL = "http://mahdipakravan.ir:3000/api";
export const REQUEST_NAVIGATION = BASE_URL + "/navbar";
export const REQUEST_CV = BASE_URL + "/cv";
...
export const REQUEST_PROJECTS = BASE_URL + "/project/paginate";
